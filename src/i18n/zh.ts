...
export const zh: Record<string, string> = {
  ...
  "settings.cliPathModal.unixNote": "在终端中运行以下命令查找路径:\nwhich gemini（或 which claude / which codex）",
  "settings.cliPathModal.versionManagerNote": "Node.js 版本管理器（nodenv、nvm、volta、fnm、asdf、mise）会被自动检测。如果检测失败，请直接指定 CLI 脚本路径（例如：~/.npm-global/lib/node_modules/@google/gemini-cli/dist/index.js）。",
  ...
  "settings.localLlmModal.modelDesc": "从服务器获取模型，然后选择一个",
